let input: HTMLInputElement = document.querySelector("#Input_bit") as HTMLInputElement
let inputGenerate: HTMLInputElement = document.querySelector("#Input_generate") as HTMLInputElement
let generateButton: HTMLInputElement = document.querySelector("#Input_generate") as HTMLInputElement
...
function GenerateBinaryNumber(): void{
    input.value = "";
...
(document.querySelector("#Button_generate") as HTMLInputElement).addEventListener("click", GenerateBinaryNumber)